...
def('O', 2, 'base', 'CRRC', [
  ...
  road([1, 2], { spot: [0.68, 0.68] }),
  field([2, 5], [0], [0.53, 0.47]),
  field([3, 4], [], [0.88, 0.88]),
]);
def('P', 3, 'base', 'CRRC', [
...
def('EC_CITY_ROADPASS', 1, 'ec', 'CRCR', [
  ...
  city([2], { spot: [0.5, 0.89] }),
  road([1, 3], { spot: [0.5, 0.5] }),
  field([2, 7], [0], [0.5, 0.31]),
  field([3, 6], [1], [0.5, 0.69]),
]);
